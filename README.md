...
> ## 🔝 一键订阅（推荐）
>
> 在 MusicFree 中「设置 → 插件设置 → 插件订阅 → 添加订阅源」，粘贴下方订阅直链即可**一次性订阅全部已收录插件**（当前含 **8 个**：我要下歌 / 布谷音乐 / QQ音乐 / 网易云音乐 / 酷我 / 酷狗 / 汽水音乐 / 哔哩哔哩）：
>
> **主订阅 · jsDelivr 直链（零跳转，桌面端 / 移动端均稳定）**
>
> ```
> https://cdn.jsdelivr.net/gh/buaiwanyouxi/musicfreemusicfree-all@main/musicfree-tianpeng.json
> ```
>
> **国内订阅 · Gitee 直连（插件全部从 Gitee 拉取，完全无需访问 jsDelivr）**
>
> ```
> https://gitee.com/koujiao/musicfree-tianpeng/raw/master/musicfree-tianpeng-gitee.json
> ```
>
> 两条订阅收录的插件相同、当前版本一致，请按你的网络情况**任选其一**：能正常访问 jsDelivr 用主订阅；国内访问不畅、或想走纯国内链路的用 Gitee 订阅。
>
> 订阅源文件详见 [musicfree-tianpeng.json](musicfree-tianpeng.json)（jsDelivr 版）与 [musicfree-tianpeng-gitee.json](musicfree-tianpeng-gitee.json)（Gitee 版）。
